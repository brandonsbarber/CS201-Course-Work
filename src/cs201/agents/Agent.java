...
import cs201.helper.StringUtil;
...
public abstract class Agent {
    ...
    /**
     * Pauses the Agent if running, or Resumes if paused.
     * @return The result of calling Pause(): true if you Paused an agent, and false if you Resumed
     */
